...
*/
    "tx",             // 0
    "cache",          // 1
    "casevac###",     // 2     CASEVAC = Casualty Evacuation
    "imhere",         // 3
    "stalker",        // 4
    "",               // 5
    "lokz",           // 6
    "",               // 7
    "gdu",            // 8     GDU = Gun Display Unit
    "fps",            // 9
    "defcon#",       // 10     DEFCON - Defense Readiness Condition
    "vtol",          // 11     VTOL = Vertical Takeoff and Landing
    "buzz",          // 12
    "wimp",          // 13
    "<RESERVED>",    // 14
    "<RESERVED>",    // 15
    "itas",          // 16     ITAS = Improved Target Acquisition System
    "recon",         // 17     RECON = Reconnaissance
    "hendricks",     // 18
    "fubar",         // 19     FUBAR = Fucked Up Beyonad All Recogmition
    "ghost",         // 20
    "gunz",          // 21
    "supply",        // 22
    "cardz",         // 23
    "abit",          // 24     ABIT = Advanced Built-In Test
    "<RESERVED>",    // 25
    "ken",           // 26
#endif
};
...

            {
                ...
                case CHEAT_COMEGETSOME:
                {
                    ...
                    if (ud.god)
                    {
                        ...
                        {
                            Bstrcpy(apStrings[QUOTE_RESERVED4], "BRING IT ON!");
                ...
                case CHEAT_MONSTERS:
                {
                    ...
                    Bsprintf(apStrings[QUOTE_RESERVED4], "Enemies: %s", s[g_noEnemies]);
                    P_DoQuote(QUOTE_RESERVED4, pPlayer);
