...
# endif
    ...
    ud.adsmode                = 0; // awol adsmode menu test
    ud.subtitles              = 1; // awol subtitles menu test
    ud.weather                = 2; // weather menu option
    ud.particles              = 1; // particles menu option
    ud.text_speed             = 2; // Text speed menu option
	ud.perf_mdl               = 1; // Model performance mode
    ...
    Bstrcpy(ud.ridecule[0], "");
    Bstrcpy(ud.ridecule[1], "");
    Bstrcpy(ud.ridecule[2], "");
    Bstrcpy(ud.ridecule[3], "");
    Bstrcpy(ud.ridecule[4], "");
    Bstrcpy(ud.ridecule[5], "");
    Bstrcpy(ud.ridecule[6], "");
    Bstrcpy(ud.ridecule[7], "");
    Bstrcpy(ud.ridecule[8], "");
