...
enum UserdefsLabel_t
{
    ...
    USERDEFS_ADSMODE, // awol adsmode menu test
    USERDEFS_SUBTITLES, // awol subtitles menu test
    USERDEFS_WEATHER, // weather menu option
    USERDEFS_PARTICLES, // particle menu option
    USERDEFS_TEXTSPEED, // Text speed menu option
	USERDEFS_PERF_MDL, // Model performance mode
    USERDEFS_END
};
