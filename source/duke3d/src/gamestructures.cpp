...
memberlabel_t const UserdefsLabels[]=
{
    ...
    { "adsmode",                USERDEFS_ADSMODE,                0, 0, -1 }, // awol adsmode menu test
    { "subtitles",              USERDEFS_SUBTITLES,              0, 0, -1 }, // awol subtitles menu test
    { "weather",                USERDEFS_WEATHER,                0, 0, -1 }, // weather menu option
    { "particles",              USERDEFS_PARTICLES,              0, 0, -1 }, // particles menu option
    { "text_speed",             USERDEFS_TEXTSPEED,              0, 0, -1 }, // Text speed menu option
	{ "perf_mdl",               USERDEFS_PERF_MDL,               0, 0, -1 } // Model performance mode
};
...
int32_t __fastcall VM_GetUserdef(int32_t labelNum, int const lParm2)
{
    ...
    switch (labelNum)
    {
        ...
        case USERDEFS_ADSMODE:                labelNum = ud.adsmode;                      break; // awol adsmode menu test
        case USERDEFS_SUBTITLES:              labelNum = ud.subtitles;                    break; // awol subtitles menu test
        case USERDEFS_WEATHER:                labelNum = ud.weather;                      break; // weather menu option
        case USERDEFS_PARTICLES:              labelNum = ud.particles;                    break; // particles menu option
        case USERDEFS_TEXTSPEED:              labelNum = ud.text_speed;                   break; // Text speed menu option
		case USERDEFS_PERF_MDL:               labelNum = ud.perf_mdl;                     break; // Model performance mode
...
void __fastcall VM_SetUserdef(int const labelNum, int const lParm2, int32_t const iSet)
{
    ...
    switch (labelNum)
    {
        ...
        case USERDEFS_ADSMODE:                      ud.adsmode                       = iSet; break; // awol adsmode menu test
        case USERDEFS_SUBTITLES:                    ud.subtitles                     = iSet; break; // awol subtitles menu test
        case USERDEFS_WEATHER:                      ud.weather                       = iSet; break; // weather menu option
        case USERDEFS_PARTICLES:                    ud.particles                     = iSet; break; // particles menu option
        case USERDEFS_TEXTSPEED:                    ud.text_speed                    = iSet; break; // Text speed menu option
		case USERDEFS_PERF_MDL:                     ud.perf_mdl                      = iSet; break; // Model performance mode
