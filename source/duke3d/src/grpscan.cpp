...
static internalgrpinfo_t const internalgrpfiles[] =
{
    ...
    */
    { "AWOL",                                  AWOL_CRC, AWOL_SZ, GAMEFLAG_AWOL,        0, "awol.def", NULL},
};
#endif
...
static void LoadList(const char * filename)
{
    ...
    */
    scriptfile_addsymbolvalue("AWOL_CRC", AWOL_CRC);
#endif
    ...
    while (!scriptfile_eof(script))
    {
        ...
        case T_GRPINFO:
        {
            ...
            int32_t gsize = 0, gcrcval = 0, gflags = GAMEFLAG_AWOL, gdepcrc = AWOL_CRC;
...
static void LoadGameList(void)
{
    ...
    BUILDVFS_FIND_REC * const srch = klistpath(base, "awol.grpinfo", BUILDVFS_FIND_FILE);
