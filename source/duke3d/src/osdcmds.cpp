...
//    KB_ClearKeysDown();
	...
	static const char *fn = "awol0000.png";
#else
...
int32_t registerosdcommands(void)
{
    ...
    static osdcvardata_t cvars_game[] =
    {
        ...
        { "crosshair", "\n 0: off\n 1: on\n 2: crosshair only", (void *)&ud.crosshair, CVAR_INT, 0, 2 },
        { "adsmode", "\n 0: toggle\n 1: hold", (void *)&ud.adsmode, CVAR_BOOL, 0, 1 }, // awol adsmode menu test
        { "subtitles", "\n 0: off\n 1: on", (void *)&ud.subtitles, CVAR_BOOL, 0, 1 }, // awol subtitles menu test
        { "weather", "\n 0: off\n 1: low\n 2: normal", (void *)&ud.weather, CVAR_INT, 0, 2 }, // weather menu option
        { "particles", "\n 0: off\n 1: on", (void *)&ud.particles, CVAR_BOOL, 0, 1 }, // particles menu option
        { "text_speed", "\n 0: off\n 1: slow\n 2: normal\n 3: fast", (void *)&ud.text_speed, CVAR_INT, 0, 3 }, // Text speed menu option
		{ "perf_mdl", "\n 0: off\n 1: on", (void *)&ud.perf_mdl, CVAR_INT, 0, 1 }, // Text speed menu option
