...
#define WIN_STARTWINPAGE_CREDITS 3000 // New line added for use by AWOL game launcher
#define WIN_STARTWIN_BITMAP	100	// banner bitmap
#define WIN_STARTWIN_TABCTL	101
#define WIN_STARTWIN_CREDITS	300	// credits bitmap
